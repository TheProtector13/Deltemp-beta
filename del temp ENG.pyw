...
menu=TK.Canvas()
menu.grid()
text=TK.Label(menu, text="This program will remove the temporary files from the computer.\nMake sure you saved and closed all workflows before you run the program!\n\n - You can change the settings in the deltemp_setting.ini file.")
